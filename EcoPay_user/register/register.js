document.addEventListener('DOMContentLoaded', () => {
   ...
   registerForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            const response = await axios.post('http://52.47.95.15/Ecopay/EcoPay_backend/V2/register.php', userData, {
                headers: {
    ...
    verifyOtpButton.addEventListener('click', async () => {
        ...
        try {
            ...
            const response = await axios.post('http://52.47.95.15/EcoPay/EcoPay_backend/V2/verify_otp.php', otpData, {
                headers: {
                    'Content-Type': 'application/json'
                }
            });
    ...
    resendOtpButton.addEventListener('click', async () => {
        ...
        try {
            ...
            const response = await axios.post('http://52.47.95.15/EcoPay/EcoPay_backend/V2/email_verify.php', resendData, {
                headers: {
                    'Content-Type': 'application/json'
                }
            });
